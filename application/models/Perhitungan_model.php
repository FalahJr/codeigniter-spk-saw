...
class Perhitungan_model extends CI_Model
{
	...
	public function get_hasil_terbaik()
	{
		$query = $this->db->query("SELECT * FROM hasil ORDER BY nilai DESC LIMIT 1;");
		return $query->row_array();
	}

	public function get_hasil_alternatif_terbaik($id_alternatif)
	{
		$query = $this->db->query("SELECT * FROM alternatif WHERE id_alternatif='$id_alternatif';");
		return $query->row_array();
	}
