...
<div class="card shadow mb-4">
	...
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-danger"><i class="fa fa-table"></i> Daftar Data Pengguna</h6>
	</div>
						...
						<tr align="center">
							...
							<td>
								<div class="btn-group" role="group">
									...
									<a data-toggle="tooltip" data-placement="bottom" title="Ubah Data" href="<?= base_url('User/edit/' . $value->id_user) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
