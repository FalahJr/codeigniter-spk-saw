				...
				<tbody>
					...
					foreach ($alternatif as $keys) : ?>
						<tr align="center">
							...
							<td>
								<?php if ($cek_tombol == 0) { ?>
									<a data-toggle="modal" href="#set<?= $keys->id_alternatif ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Masukkan</a>
								<?php } else { ?>
									<a data-toggle="modal" href="#edit<?= $keys->id_alternatif ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Ubah</a>
								<?php } ?>
							</td>
						</tr>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Masukkan Penilaian</h5>
