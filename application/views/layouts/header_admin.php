 ...
 <head>
   ...
   <link rel="icon" href="<?= base_url('assets/') ?>img/logoclakt.png" type="image/x-icon">
 ...
 <body id="page-top">
   ...
   <div id="wrapper">
     ...
     <!-- Sidebar -->
     <ul class="navbar-nav  sidebar sidebar-dark accordion" style="background: #c0392b" id="accordionSidebar">

       <!-- Sidebar - Brand -->
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('Login/home'); ?>">
         <div class="sidebar-brand-icon rotate-n-0">
           <img src="<?= base_url('assets/') ?>img/logoclakt.png" width="40 px">
         </div>
