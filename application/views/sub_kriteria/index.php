						...
						?>
							<tr align="center">
								...
								<td>
									<div class="btn-group" role="group">
										<a data-toggle="modal" title="Ubah Data" href="#editsk<?= $key['id_sub_kriteria'] ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
							...
							<div class="modal fade" id="editsk<?= $key['id_sub_kriteria'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="myModalLabel"><i class="fa fa-edit"></i> Ubah <?= $key['deskripsi'] ?></h5>
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										</div>
